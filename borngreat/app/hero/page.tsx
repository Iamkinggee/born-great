...
//               </svg>
//               <span className="text-white font-bold text-xl">Kindazai</span>
//             </div>

//             {/* Desktop Menu */}
//             <div className="hidden md:flex items-center gap-8">
//               <a href="#" className="text-white text-sm font-medium hover:opacity-80 transition">Home</a>
//               <a href="#" className="text-white text-sm font-medium hover:opacity-80 transition">About</a>
//               <a href="#" className="text-white text-sm font-medium hover:opacity-80 transition">Courses</a>
//               <a href="#" className="text-white text-sm font-medium hover:opacity-80 transition">Pricing</a>
//               <a href="#" className="text-white text-sm font-medium hover:opacity-80 transition">Products</a>
//               <a href="#" className="text-white text-sm font-medium hover:opacity-80 transition">Pages</a>
//               <a href="#" className="text-white text-sm font-medium hover:opacity-80 transition">Contact</a>
//             </div>
...
//               </button>
//               <button className="bg-gray-800 hover:bg-gray-900 text-white px-6 py-2 rounded-lg font-medium transition">
//                 Guardian Login
//               </button>
//             </div>
...
//       {/* Hero Section */}
//       <div className="pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative">
//         <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-120px)]">
          
//           {/* Left Content */}
//           <div className="flex flex-col justify-center z-10">
//             {/* Decorative Elements */}
//             <div className="absolute left-0 top-20 w-24 h-24 opacity-40">
...
//             <div className="absolute right-0 top-1/3 w-32 h-32 opacity-30">
...
//             <button className="inline-flex items-center justify-center bg-gray-800 hover:bg-gray-900 text-white font-bold py-3 px-8 rounded-lg transition transform hover:scale-105 w-fit">
//               Discover More
...
//               <div className="absolute bottom-0 left-0 w-48 h-32 bg-white rounded-full blur-3xl opacity-40"></div>
//               <div className="absolute bottom-16 right-0 w-56 h-40 bg-white rounded-full blur-3xl opacity-30"></div>
//               <div className="absolute bottom-0 right-32 w-64 h-48 bg-white rounded-full blur-3xl opacity-35"></div>
//             </div>

//             {/* Kids Illustration Placeholder */}
//             <div className="relative z-10 w-full max-w-md aspect-square bg-gradient-to-b from-transparent via-cyan-200 to-white rounded-3xl shadow-2xl flex items-center justify-center border-8 border-white/20">
//               <div className="text-center">
//                 <div className="text-6xl mb-4">👧👧🧒</div>
//                 <p className="text-cyan-600 font-semibold">Three Happy Kids</p>
//                 <p className="text-sm text-gray-600 mt-2">Learning & Growing</p>
//               </div>
//             </div>

//             {/* Floating Elements */}
//             <div className="absolute top-20 right-10 w-12 h-12 animate-pulse">
...
//             <div className="absolute bottom-32 -left-10 w-16 h-16 animate-bounce" style={{animationDelay: '0.5s'}}>
//               <svg viewBox="0 0 100 100" className="w-full h-full text-white drop-shadow-lg">
...
//             <div className="absolute top-1/3 right-0 w-14 h-14 animate-bounce" style={{animationDelay: '1s'}}>
//               <svg viewBox="0 0 100 100" className="w-full h-full text-white drop-shadow-lg">
...
//       <div className="absolute bottom-0 w-full h-32 bg-gradient-to-t from-blue-200 to-transparent pointer-events-none"></div>
//     </div>
//   );
// }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-white font-bold text-lg sm:text-xl">Kindazai</span>
            </div>
      ...
      <div className="pt-20 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-screen lg:min-h-[calc(100vh-100px)] py-8">
          ...
          <div className="relative h-64 sm:h-80 lg:h-full flex items-center justify-center lg:justify-end order-1 lg:order-2">
            ...
            {/* Kids Illustration Placeholder */}
            <div className="relative z-10 w-full max-w-xs sm:max-w-sm lg:max-w-md aspect-square bg-gradient-to-b from-transparent via-cyan-200 to-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-2xl flex items-center justify-center border-4 sm:border-8 border-white/20">
              <div className="text-center">
                <div className="text-5xl sm:text-6xl mb-3 sm:mb-4">👧👧🧒</div>
                <p className="text-cyan-600 font-semibold text-sm sm:text-base">Three Happy Kids</p>
                <p className="text-xs sm:text-sm text-gray-600 mt-1 sm:mt-2">Learning & Growing</p>
              </div>
            </div>
